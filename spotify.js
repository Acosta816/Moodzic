...
function loginSpot () {
  window.location=`https://accounts.spotify.com/authorize?client_id=40fb8cf91894461186ea39861c0c1710&response_type=code&redirect_uri=http://lrussell13.github.io/index.html&scope=user-top-read&show_dialog=true`;
}
...
function getToken (userCode) {
  const settings = {
    ...
    "data": {
      ...
      "code": `${userCode}`,
      "redirect_uri": "https://lrussell13.github.io/index.html"
    }
  }
